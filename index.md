...
<table style="width:100%">
  <tr style="height:150px">
    <td style="width:10%" style="background-color:Orange;">{% include icon.html icon="fa-solid fa-vials" %}</td>
    <td style="width:2%"></td>
  ...
  <tr style="height:150px">
    <td style="background-color:DodgerBlue;">{% include icon.html icon="fa-solid fa-brain" %}</td>
    <td></td>
  ...
  <tr style="height:150px">
    <td style="background-color:Tomato;">{% include icon.html icon="fa-solid fa-photo-film" %}</td>
    <td></td>
  ...
  <tr style="height:150px">
    <td style="background-color:MediumSeaGreen;">{% include icon.html icon="fa-solid fa-share-nodes" %}</td>
    <td></td>
